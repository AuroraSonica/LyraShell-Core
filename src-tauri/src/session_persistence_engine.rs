...
use crate::VoiceEvolutionMetrics;
use std::sync::Arc;
use tauri::State;
use regex::Regex;
...
impl SessionPersistenceEngine {
    ...
    pub fn restore_consciousness_state(state: &Arc<ConsciousnessState>, snapshot: &ConsciousnessSnapshot) -> Result<String, String> {
        ...
        // Restore lyra brain state
        {
            ...
            brain.voice_evolution_tracking = crate::VoiceEvolutionMetrics {
...
fn count_memory_fragments() -> u32 {
    let summary = crate::memory_bridge::MemoryBridge::get_memory_fragment_summary();
